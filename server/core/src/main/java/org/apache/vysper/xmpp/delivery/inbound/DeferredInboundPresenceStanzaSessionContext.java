...
public class DeferredInboundPresenceStanzaSessionContext extends AbstractSessionContext
        implements StanzaWriter {

    public DeferredInboundPresenceStanzaSessionContext(ServerRuntimeContext serverRuntimeContext,
